<?php require "common/header.php" ?>
    ...
    <main>
        ...
        <section class="breadcrumb bg_img ul_li" data-background="assets/img/bg/breadcrumb_bg.jpg">
            <div class="container">
                <div class="breadcrumb__content text-center">
                    <h2 class="breadcrumb__title">Tuition & Fees</h2>
                    <p class="breadcrumb__desc">Understanding the Cost of Your Education</p>
                </div>
            </div>
        </section>
        <!-- breadcrumb end -->
        ...
        <!-- tuition & fees start -->
        <section class="tution-fees pt-80 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 mt-30">
                        <div class="section-title section-title--md">
                            <span class="sub-title">Tuition & Fees</span>
                            <h2 class="title mb-20">Everything You Need to Know About Tuition & Fees A Comprehensive Overview</h2>
                            <p>Everything You Need to Know About Tuition & Fees offers a <br> thorough exploration into the financial aspects of pursuing.</p>
                        </div>
                    ...
                    <div class="col-xl-5 offset-xl-1 col-lg-6 mt-30">
                        <div class="tution-fees-image text-center">
                            <img src="assets/img/bg/faq_image.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="department pt-115 pb-90 pos-rel">
            <div class="container">
                ...
                <div class="xb-feature-shape">
                    <span class="shape shape--one"><img src="assets/img/shape/stamp.png" alt=""></span>
                    <span class="shape shape--two"><img src="assets/img/shape/cap.png" alt=""></span>
                </div>
            </div>
        </section>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="xb-item--holder">
                                            ...
                                            <p class="xb-item--content">"Career Buddy College University has been a game-changer for me. The expert faculty, practical learning experiences, and supportive community have prepared me well for my career. The campus life and top-notch facilities."</p>
                                        </div>
            ...
            <div class="container">
                <div class="funfact-inner ul_li_between">
                    <div class="funfact-item mt-30">
                        ...
                        <p class="xb-item--contact">Career Buddy College Arizona first-year <br> cohort has a record 3.97 GPA.</p>
                    </div>
                    <div class="funfact-item mt-30">
                        <h3 class="xb-item--title">3.97<span>cGPA</span></h3>
                        <p class="xb-item--contact">Career Buddy College Arizona first-year <br> cohort has a record 3.97 GPA.</p>
                    ...
                    <div class="col-lg-6 mt-30">
                        <div class="cta-item pos-rel" data-background="assets/img/cta/cta_img1.jpg">
                            <div class="cta-inner" >
                                ...
                                <a class="thm-btn thm-btn--gray" href="contact.php">apply now
