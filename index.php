         ...
         <section class="blog pt-115 pb-120 bg_img" data-background="assets/img/bg/news_bg01.jpg">
            <div class="container">
                        ...
                        <div class="xb-blog__left">
                            <div class="xb-blog pos-rel mt-20">
                                ...
                                <div class="xb-item--holder">
                                    ...
                                    <h2 class="xb-item--title border-effect-2"> <a href="blog-single.php">EduFord University Hosts International on Climate..</a></h2>
                                </div>
                            </div>
                            <div class="xb-blog pos-rel mt-20">
                                <div class="xb-item--img">
                                ...
                                <div class="xb-item--holder">
                                    ...
                                    <h2 class="xb-item--title border-effect-2"> <a href="blog-single.php">Thirty-one UChicago faculty members receive named..</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-8">
                        <div class="xb-blog chn-margin pos-rel mt-20">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect"> <a href="blog-single.php">EduFord University Receives Grant for <br> Advanced STEM Programs..</a></h2>
                        ...
                        <div class="xb-blog__right">
                            <div class="xb-blog mr-left pos-rel mt-20">
                                ...
                                <div class="xb-item--holder">
                                    ...
                                    <h2 class="xb-item--title border-effect-2"> <a href="blog-single.php">our Awarded National for Community Outreach..</a></h2>
                                </div>
                            </div>
                            <div class="xb-blog mr-left pos-rel mt-20">
                                <div class="xb-item--img">
                                ...
                                <div class="xb-item--holder">
                                    ...
                                    <h2 class="xb-item--title border-effect-2"> <a href="blog-single.php">Expands Campus Facilities <br> with State of-the-Art Lab..</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="xb-btn text-center pt-60">
                    <a class="thm-btn" href="blog.php">More Campus News
                        ...
                        <div class="col-lg-3 col-md-6 mt-30 mb-30 dp-col">
                            <div class="xb-dep-wrapper">
                                <div class="xb-department text-center pos-rel">
                                    ...
                                    <span>Course: 20</span>
                                    <a class="div-link" href="courses.php"></a>
                                </div>
                                <div class="xb-department text-center pos-rel">
                                    <div class="xb-item--icon">
                            ...
                            <div class="swiper-slide">
                                <div class="xb-fanfact__wrapper pos-rel">
                                    ...
                                    <div class="xb-item--holder">
                                        ...
                                        <p class="xb-item--content">Career Buddy College University hosts a variety of specialized institutes focused on advancing knowledge.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
            ...
            <div class="container">
                <div class="pro-top ul_li_between mb-40">
                    ...
                    <div class="pro-btn mb-20">
                        <a class="thm-btn thm-btn--stroke-black" href="courses.php">view all programs
                            <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Biomedical Engineering..</a></h2>
                                ...
                                <div class="xb-item--dep-btn">
                                    <a href="course-single.php">enroll now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Advanced Construction..</a></h2>
                                <ul class="xb-item--meta ul_li">
                    ...
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Management and Strategic..</a></h2>
                                <ul class="xb-item--meta ul_li">
                    ...
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Mechanical Engineering..</a></h2>
                                <ul class="xb-item--meta ul_li">
                    ...
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Sustainable Energy..</a></h2>
                                <ul class="xb-item--meta ul_li">
                                    <li><img src="assets/img/icon/meta-icon01.png" alt="">200 Seat</li>
                                    <li><img src="assets/img/icon/clock.png" alt="">14 Semester</li>
                                </ul>
                    ...
                    <div class="col-lg-4 col-md-6 mt-60">
                        <div class="xb-program__wrapper">
                            ...
                            <div class="xb-item--holder">
                                ...
                                <h2 class="xb-item--title border-effect-2"><a href="course-single.php">MBA in Real Estate and Urban..</a></h2>
                                <ul class="xb-item--meta ul_li">
                        ...
                        <div class="xb-event-wrapper pos-rel mt-20">
                            <div class="xb-event-left ul_li align-items-center">
                                ...
                                <div class="xb-item--author">
                                    ...
                                    <h2 class="xb-item--title border-effect"><a href="event-single.php">Throw an event to kick off a mentorship program..</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
